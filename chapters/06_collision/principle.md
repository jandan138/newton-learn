...
![body 提供运动，shape 提供几何](assets/06_principle_shape_not_body_boundary.png)
...
![broad phase 只产生 candidate pairs](assets/06_principle_broad_phase_maybe_list.png)
...
![narrow phase 把 maybe-pair 变成 contact geometry](assets/06_principle_narrow_phase_contact_geometry.png)
...
![shape_type 决定 narrow-phase 分路](assets/06_principle_shape_type_routing.png)
...
![ContactData 压缩成 Contacts handoff](assets/06_principle_contacts_handoff_buffer.png)
...
![06 到 07 / 08 的章节边界](assets/06_principle_next_chapters_map.png)
