...
name="friction", assignment=newton.Model.AttributeAssignment.MODEL

name="particle_qd_grad", assignment=newton.Model.AttributeAssignment.STATE
name="particle_elastic_strain", assignment=newton.Model.AttributeAssignment.STATE
name="particle_Jp", assignment=newton.Model.AttributeAssignment.STATE
name="particle_stress", assignment=newton.Model.AttributeAssignment.STATE
```
...
solve_rheology(..., momentum_data, rheology_data, collision_data, ...)
```
